...
public class KendoDateTimePicker {
	...
	public void SelectDateFromKendoCalendar() throws InterruptedException {
		...
		// choose time
//		WebElement iconTime = driver.findElement(By.cssSelector(".k-icon.k-i-clock"));
//		iconTime.click();
//		WebElement chooseTime = driver.findElement(By.cssSelector("#datetimepicker_timeview > li:nth-child(5) > span"));
//		chooseTime.click();
	...
	public void HandleKendoDateTimePicker_for_time(String time) throws InterruptedException {
		/// FOR TIME
		WebElement selectTime = driver.findElement(By.cssSelector(".k-icon.k-i-clock"));
		...
		List<WebElement> allTime = driver.findElements(
				By.xpath("//ul[@id='datetimepicker_timeview']//li[@role='option']"));
	...
	public void HandleKendoDateTimePicker_change_month_with_next() throws InterruptedException {
		wait.until(ExpectedConditions.presenceOfElementLocated(By.className("k-calendar-nav-next")));

		// click buton
		WebElement next = driver.findElement(By.cssSelector(".k-calendar-nav-next"));
