package selenium.webdriver.practices;
...
public class PopupOfindow {
	...
	public static void main(String[] args) {
		...
		try {
			...
			driver.findElement(By.id("identifierId")).sendKeys("vanvtt.pnv@gmail.com");
			...
			driver.findElement(By.xpath("//input[@type='password']")).sendKeys("thoigian@#@#");
