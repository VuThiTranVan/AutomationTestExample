...
public class AccessingLinksExample {
	...
	/**
	 * Example 01: Using By.linkText() find by text "Bank Project" return: title
	 * is Guru99 Bank Home Page
	 */
	...
	private static void example_7(WebDriver driver) {
		String baseUrl = "https://www.google.com/search?client=ubuntu&channel=fs&q=selennium&ie=utf-8&oe=utf-8";
		driver.get(baseUrl);
		System.out.println("\n");
