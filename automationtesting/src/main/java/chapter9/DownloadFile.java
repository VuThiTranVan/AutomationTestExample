...
public class DownloadFile {
	public static void main(String[] args) {
		...
		wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("/html/body/div/div/div[1]/div/div/ul/li[6]/ul/li[1]/a")));
		...
		WebElement btnDownload = driver
				.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[2]/div[1]/div/div/div/a[2]"));
		btnDownload.click();
